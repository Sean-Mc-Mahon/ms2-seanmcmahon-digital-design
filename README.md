...
- User Story A: Joe is an architect and would like to like to commission renders of a project he is working on to assist with a planning application.
- User Story B: Joe would also like to commission a 3D model of a project to demonstrate his ideas to a client.
- User Story C: Liz is interested in commissioning some modern furniture for her living room.
- User Story D: Hazel would like to commission a digital portrait as an anniversary present.
